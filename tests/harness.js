...
const SCRIPT_PATH = path.join(__dirname, '..', 'AICHATBUTTONS.js');
...
// ---------------------------------------------------------------------------
// Selector engine (subset of CSS used by AICHATBUTTONS.js)
// ---------------------------------------------------------------------------
...
function createHarness() {
  ...
  harness.load = () => {
    ...
    try {
      vm.runInContext(source, sandbox, { filename: 'AICHATBUTTONS.js' });
    } catch (error) {
